    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><span class="text-muted fw-light"> {{ trans('companies/companies_trans.add') }} /</span>
                {{ trans('companies/companies_trans.new customer') }}</h4>
            @if (session('success'))
                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">{{ trans('companies/companies_trans.new customer') }}</h5>
                            <small
                                class="text-muted float-end">{{ trans('companies/companies_trans.new customer') }}</small>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('company.customer.store') }}" method="post">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label"
                                        for="basic-default-firstname">{{ trans('companies/companies_trans.first Name') }}
                                    </label>
                                    <input type="text"
                                ...
                                <div class="mb-3">
                                    <label class="form-label"
                                        for="basic-default-lastname">{{ trans('companies/companies_trans.last Name') }}
                                    </label>
                                    <input type="text"
