                ...
                <form class="add-new-record pt-0 row g-2" id="form-add-new-record" onsubmit="return false">
                    ...
                    @if (Auth::user()->role == 0)
                        <div class="col-sm-12">
                            <div class="">
                                <label class="form-label"
                                    for="basicFullvendor_id">{{ trans('vendors/vendors_trans.Select vendor') }}</label>
                                <select class="select2 form-select form-select-lg dt-vendor_id" name="vendor_id"
                                    aria-describedby="vendor_id2">
                                    <option value="" selected>
                                        {{ trans('vendors/vendors_trans.Select vendor') }}</option>
                                    @if ($vendors)
