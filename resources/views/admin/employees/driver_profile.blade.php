...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-2"><span class="text-muted fw-light">driver Profile /</span>
            </h4>
            <form action="/admin/driver/profile/{{ $id }}" method="get">
            ...
            <div class="card" id="test">
                <div class="card-datatable table-responsive pt-0">
                    <table class="datatables-basic-driver_profile table">
                        <thead>
                            <tr>
                                <th></th>
                                <th></th>
