...
@section('title', trans('employees/employees_trans.edit employee'))
    ...
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><span class="text-muted fw-light"> {{ trans('drivers/drivers_trans.edit') }} /</span>
                {{ trans('employees/employees_trans.edit employee') }} </h4>
            <div class="row">
                <!-- Basic Layout -->
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <small
                                class="text-muted float-end">{{ trans('employees/employees_trans.Add an employee') }}</small>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('update.employee', $employee->id) }}" method="post">
                                ...
                                <div class="mb-3">
                                    <label class="form-label"
                                        for="basic-default-name">{{ trans('employees/employees_trans.name') }}</label>
                                    <input type="text"
                                        class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}"
                                        id="basic-default-name" placeholder="{{ trans('employees/employees_trans.name') }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="basic-default-phone"
                                        ...
                                        placeholder="658 799 8941" name="phone" value="{{ $employee->phone }}" />
                                    @if ($errors->has('phone'))
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="basic-default-email"
                                            ...
                                            placeholder="email@example.com" name="email" value="{{ $employee->email }}"
                                ...
                                <div class="mb-3 form-password-toggle">
                                    <label class="form-label"
                                        for="multicol-password">{{ trans('employees/employees_trans.job') }}</label>
                                    <div class="input-group input-group-merge">
                                ...
                                <div class="mb-3">
                                    <label class="form-label"
                                        for="basic-default-salary">{{ trans('employees/employees_trans.Salary') }}</label>
                                    <input type="text" id="basic-default-salary"
                                        class="form-control {{ $errors->has('salary') ? 'is-invalid' : '' }}"
                                        placeholder="الراتب" name="salary" value="{{ $employee->salary }}" />
