...
<div class="card-body">
                        <form action="{{ route('admin.mang.store') }}" method="post" class="add-new-record pt-0 row g-2" id="form-add-new-record">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" id="basic-default-address" placeholder="{{ trans('managers/managers_trans.last Name') }}" name="address" value="{{ old('address') }}" />
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    placeholder="{{ trans('managers_trans.Phone') }}"
                                    name="phone"
                                    value="{{ old('phone') }}" />
                                @if ($errors->has('phone'))
