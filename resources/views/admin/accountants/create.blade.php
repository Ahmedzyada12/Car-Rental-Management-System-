...
@section('content')
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><span class="text-muted fw-light"> {{ trans('accountants/accountants_trans.add') }} /</span>
                {{ trans('accountants/accountants_trans.New accountant') }} </h4>
            <div class="row">
                <!-- Basic Layout -->
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">{{ trans('accountants/accountants_trans.Add a accountant') }}</h5>
                            <small
                                class="text-muted float-end">{{ trans('accountants/accountants_trans.Add a accountant') }}</small>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.Accountant.store') }}" method="post">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label"
                                        for="basic-default-firstname">{{ trans('drivers/drivers_trans.first Name') }}</label>
                                    <input type="text"
                                ...
                                <div class="mb-3">
                                    <label class="form-label"
                                        for="basic-default-lastname">{{ trans('drivers/drivers_trans.last Name') }}</label>
                                    <input type="text"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="text" id="basic-default-email"
                                            ...
                                            value="{{ old('email') }}" aria-describedby="basic-default-email2" />
