                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">{{ trans('accountants/accountants_trans.edit accountant') }} </h5>
                            <small class="text-muted float-end">{{ trans('accountants/accountants_trans.edit accountant') }}
                            </small>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.Accountant.edit', $accountant->user_id) }}" method="post">
                                @csrf
                                <div class="mb-3">
                                    <label class="form-label"
                                        for="basic-default-firstname">{{ trans('drivers/drivers_trans.first Name') }}
                                    </label>
                                    <input type="text" value="{{ old('first_name', $accountant->first_name) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" value ="{{ old('last_name', $accountant->last_name) }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('address', $accountant->address) }}" />
