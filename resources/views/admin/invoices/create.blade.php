...
@section('content')
    <div class="content-wrapper">
        <div class="container-xxl flex-grow-1 container-p-y">
            <h4 class="py-3 mb-4"><span class="text-muted fw-light"> {{ trans('managers/managers_trans.add') }} /</span>
                ...
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">{{ trans('invoices/invoices_trans.add invoice') }}</h5>
                            <small class="text-muted float-end">{{ trans('invoices/invoices_trans.add invoice') }}</small>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.invoice.store') }}" method="post">
                                ...
                                <div class="col-md-12 mb-4">
                                    <label for="select2Basic" class="form-label">
                                        {{ trans('invoices/invoices_trans.select customer') }}</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('payment_method') }}"
                                        id="how" name="payment_method" placeholder="payment method" />
