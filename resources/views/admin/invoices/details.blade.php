    ...
    <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row gy-4 gy-sm-1">
                        <div class="col-6">
                            <div
                                ...
                                <div>
                                    <h4 class="mb-2">{{ $invoice->amount }}</h4>
                                    <p class="mb-0 fw-medium">{{ trans('invoices/invoices_trans.amount') }}</p>
                                </div>
                                <span class="avatar p-2 me-lg-4">
                                    <span class="avatar-initial bg-label-secondary rounded"><i
                                            class="fa-solid ti-md ti text-body fa-dollar-sign"></i></span>
                                </span>
                            </div>
                        ...
                        <div class="col-6">
                            <div
                                ...
                                <div>
                                    <h4 class="mb-2">{{ $invoice->paid }}</h4>
                                    <p class="mb-0 fw-medium">{{ trans('invoices/invoices_trans.paid') }}</p>
                                </div>
        ...
        <div class="card">
            <div class="card-datatable table-responsive pt-0">
                <table class="datatables-basic60 table">
                    <thead>
                        <tr>
                            <th></th>
                            <th></th>
                            <th>id</th>
                            <th>{{ trans('invoices/invoices_trans.created_at') }}</th>
